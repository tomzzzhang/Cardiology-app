...
| authoring mode | [`authoring-mode.md`](authoring-mode.md) | implemented through guarded export-to-pack ingestion: camera placement, monotonic draft-depth expansion, local overrides, IndexedDB persistence, and strict export/import. Four-chamber axis capture is REMOVED (2026-08-21): no imaging view defines the patient frame. Outstanding: broader authoring workflow |
